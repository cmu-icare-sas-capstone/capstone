...
def plot_scatter(data, x, y, height, width, margin, residual=False, title_text=None):
    if residual:
        ...
        fig.add_annotation(
                    ...
                    x=0.73,
                    y=0.98,
                    text=f"Train R²: {round(r2_score(data.loc[data['split'] == 'train']['Length of Stay'], data.loc[data['split'] == 'train']['prediction']), 3)}",
                    bordercolor="#c7c7c7",
                    borderwidth=2,
                    borderpad=4,
                    bgcolor="red",
        ...
        fig.add_annotation(
                    ...
                    x=0.73,
                    y=0.89,
                    text=f"Train RMSE: {round(mean_squared_error(data.loc[data['split'] == 'train']['Length of Stay'], data.loc[data['split'] == 'train']['prediction'], squared=False), 2)}",
                    bordercolor="#c7c7c7",
                    borderwidth=2,
                    borderpad=4,
                    bgcolor="red",
